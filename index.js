...
function is31Flavors(originalFlavors){
    // var length = originalFlavors.length
    // console.log(length)
...
function addFlavor(originalFlavors, new_flavor){
    new_flavor = "Rainbow Sherbert"
    originalFlavors.unshift(new_flavor)
}
...
function getFlavorByIndex(originalFlavors, index){
    var index = 4
    var getFlavor = originalFlavors[index]
...
function removeFlavorByName(originalFlavors){
    originalFlavors.splice(30, 1) // if you console.log this, it will return the removed elem - which is Vanilla
    console.log("Remove Vanilla", originalFlavors)
}
...
function copy(originalFlavors, copyFlavors){
    copyFlavors = [...originalFlavors] // this is called the spread opertor "..."
